...
> **Tests:** `./gradlew testDebugUnitTest` — **434** JVM `@Test` (56 files); run `./scripts/smoke-ci.sh` for full gate.
...
- [x] **8E.1** `scripts/fill_america_coords.py` — Nominatim + cache; 98 coords added
