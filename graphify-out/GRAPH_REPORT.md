...
2. `citiesByCountry` - 116 edges
3. `countryDefaults` - 97 edges
4. `countryDefaults` - 97 edges
5. `PrayerTimeCalculatorTest` - 38 edges
...
Cohesion: 0.15
Nodes (13): 2.10 Audit Claims Must Be Code-Verified Before Acting, 2.11 Architecture visibility (Graphify), 2.11 Maintaining Architecture Visibility, 2.1 Contracts first, implementation second, 2.2 Prefer explicit result objects for operations, 2.3 Error normalization strategy, 2.4 Keep domain logic extractable and testable, 2.5 Avoid Backend Entry-Point Bloat (The "No-Monolith" Rule) (+5 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (116): citiesByCountry, AD, AE, AF, AL, AM, AR, AT (+108 more)
...
Cohesion: 0.10
Nodes (20): Agent rules, AGENTS — PrayerTime- Project Setup, APK sizes (debug builds), App themes (5E.16–19), Architecture (post-2F hardening), Async LocationDataSource, Boot-time adhan reschedule, Build environment (+12 more)

### Community 36 - "Community 36"
Cohesion: 0.10
Nodes (20): code, data, date, meta, timings, gregorian, readable, timestamp (+12 more)
...
Cohesion: 0.27
Nodes (20): android, Boolean, CalendarPalette, Color, Int, IslamicEvent, Modifier, String (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (14): AppWidgetManager, Float, Int, IntArray, Float, extract_block(), main(), parse_cities_by_country() (+6 more)

### Community 41 - "Community 41"
Cohesion: 0.21
Nodes (7): Date, Int, List, Prayer, PrayerTime, String, LocalPrayerTimeCalculatorTest

### Community 42 - "Community 42"
Cohesion: 0.18
Nodes (13): Boolean, CityConfig, Flow, InMemoryCityConfigDataSource, PrayerTimesResult, SaveCityResult, defaultSuccessResult(), failingSave() (+5 more)

### Community 43 - "Community 43"
Cohesion: 0.18
Nodes (7): AppTheme, Boolean, Flow, Long, Set, String, AppPreferencesDataSource

### Community 44 - "Community 44"
Cohesion: 0.27
Nodes (9): Date, List, Long, Map, Prayer, PrayerTime, String, TimeZone (+1 more)
...
Cohesion: 0.20
Nodes (10): 0) Purpose of this playbook, 10) Maintenance rule for this playbook, 12) Architecture Migration Pattern, 13) Critical Agent Verification Directive, 8) Reusable build sequence (for this project), 9) Case Studies — Incident Log (Planned / Hypothetical), 9) Case Studies — Incident Log (Project-Specific), Incident Entry Template (+2 more)

### Community 78 - "Community 78"
Cohesion: 0.20
Nodes (9): AladhanResponse, Int, String, AladhanResponse, DateInfo, GregorianDate, Meta, TimingData (+1 more)

### Community 79 - "Community 79"
Cohesion: 0.27
Nodes (8): Boolean, PrayerApiGeocode, String, Throwable, TimingsWithGeocode, PrayerApi, key(), ScenarioPrayerApi

### Community 80 - "Community 80"
Cohesion: 0.18
Nodes (11): latitude, longitude, timezone, countryDefaults, BD, ET, PY, latitude (+3 more)
